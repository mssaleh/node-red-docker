...
Let's dissect that command:
        ...
        nodered/node-red        - the image to base it on - currently Node-RED v4.0.8
...
Running that command should give a terminal window with a running instance of Node-RED.
        ...
        10 Oct 12:57:10 - [info] Node-RED version: v4.0.8
...
|----------------------------------------|--------------------------------------------|
| latest, 4.0.8,                         | nodered/node-red:4.0.8-20                  |
| latest-20, 4.0.8-20                    |                                            |
|                                        |                                            |
|                                        |                                            |
| latest-minimal, 4.0.8-minimal,         | nodered/node-red:4.0.8-20-minimal          |
| latest-20-minimal, 4.0.8-20-minimal    |                                            |
|                                        |                                            |
...
| **Tag**                                | **Node-RED Base Image**                    |
|----------------------------------------|--------------------------------------------|
| latest-18, 4.0.8-18                    | nodered/node-red:4.0.8-18                  |
|                                        |                                            |
| latest-18-minimal, 4.0.8-18-minimal    | nodered/node-red:4.0.8-18-minimal          |


| **Tag**                                | **Node-RED Base Image**                    |
|----------------------------------------|--------------------------------------------|
| latest-22, 4.0.8-22                    | nodered/node-red:4.0.8-22                  |
|                                        |                                            |
| latest-22-minimal, 4.0.8-22-minimal    | nodered/node-red:4.0.8-22-minimal          
...
For example: suppose you are running on a Raspberry PI 3B, which has `arm32v7` as architecture. Then just run the following command to pull the image (tagged by `4.0.8-20`), and run the container.
...
## Managing settings.js
By default, this project now copies the default settings.js into the /data folder 
if it is missing. Since /data is persisted, you can modify settings.js directly in /data 
without losing it on upgrades or restarts.

Ensure that your /data directory is writable by the Node-RED user (uid=1000). If needed:
...
The main sections to modify are
    ...
    "dependencies": {
        "node-red": "^4.0.8",           <-- set the version of Node-RED here
